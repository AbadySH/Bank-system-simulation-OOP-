...
static const string CurrencyFileName ="/Users/badyalshryf/Desktop/Bank system simulation (OOP)/Currencies.txt";
class clsCurrency
{
...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = "#//#")
    {
        ...
        vCurrencyData = clsString::vSplitString(Line, Seperator);
...
public:
  ...
  static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::UpperAllLatterOfTheString(CurrencyCode);
  ...
  {
      Country = clsString::UpperAllLatterOfTheString(Country);
      ...
      if (MyFile.is_open())
      {
          ...
          {
              clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
              if (clsString::UpperAllLatterOfTheString(Currency.Country()) == Country)
              {
                  MyFile.close();
                  return Currency;
              }
